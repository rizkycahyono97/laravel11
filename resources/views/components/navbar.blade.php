...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex items-center">
        ...
        <div class="ml-10 flex items-baseline space-x-4">
            ...
            {{-- akan mengevaluasi apakah URL saat ini adalah '/' (Home). Jika benar (URL yang sedang aktif adalah root), maka nilai :active akan menjadi true. Jika tidak, nilainya akan menjadi false. --}}
